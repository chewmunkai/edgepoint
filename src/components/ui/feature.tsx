...
function MarketRealityFeature({
  ...
  return (
    <section id="market-reality" className="w-full py-20 lg:py-32 bg-black">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-6">
              <div>
                <Badge className="bg-neon/10 text-neon border-neon/30 hover:bg-neon/20 font-body">
                  {eyebrow}
                </Badge>
              </div>
              <div className="flex flex-col gap-4">
                <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white">
                  {headline}{" "}
            ...
            <div className="grid gap-6">
              {features.map((feature, index) => (
                <div key={index} className="flex gap-4 items-start">
                  <div className="w-6 h-6 rounded-full bg-neon/20 border border-neon/40 flex items-center justify-center flex-shrink-0 mt-1">
          ...
          {/* Right Image */}
          <div className="relative aspect-square lg:aspect-[4/3] rounded-2xl overflow-hidden border border-white/10">
            <img
              src={imageSrc}
              alt="Market Reality"
              ...
              onError={(e) => {
                ...
                target.onerror = null;
                target.src = 'https://placehold.co/800x600/1a1a2e/99FF33?text=Market+Reality';
              }}
            />
            {/* Overlay gradient */}
