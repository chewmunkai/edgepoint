...
const marketRealityData = [
  {
    ...
    color: "#99FF33",
    highlightWords: ["Competition", "skeptical", "saturated", "strategic", "precision"],
  },
  {
    ...
    color: "#FFD700",
    highlightWords: ["fails", "budgets", "foundation", "disconnect", "leaks"],
  },
  {
    title: "The Truth",
    description:
    ...
    color: "#FFFFFF",
    highlightWords: ["Success", "precision", "measurable", "smartest", "compound"],
  },
];
